    ...
    implements KeyToolRequest
{
    ...
    /**
     * The keytool command used by the keytool command to execute this request.
     */
    private final String keytoolCommand;
    ...
    protected AbstractKeyToolRequest( String keytoolCommand )
    {
        this.keytoolCommand = keytoolCommand;
    }

    /**
     * {@inheritDoc}
     */
    public final String getKeytoolCommand()
    {
