 ...
 * @version $Id$
 * @plexus.component role="org.codehaus.mojo.shared.keytool.KeyTool" role-hint="default"
 * @since 1.0
 */
    ...
    implements KeyTool
{
    ...
    protected Commandline createCommandLine( KeyToolRequest request )
        throws KeyToolException
    {
        KeyToolCommandLineBuilder cliBuilder = new KeyToolCommandLineBuilder();
        cliBuilder.setLogger( getLogger() );
        cliBuilder.setKeyToolFile( keyToolFile );
        Commandline cli;
        try
        {
